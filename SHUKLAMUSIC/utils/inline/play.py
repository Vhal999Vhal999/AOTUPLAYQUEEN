...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="‣‣I", callback_data=f"ADMIN Skip|{chat_id}", icon_custom_emoji_id=6062169402831279585, style=ButtonStyle.PRIMARY),
            InlineKeyboardButton(text="II", callback_data=f"ADMIN Pause|{chat_id}", icon_custom_emoji_id=5409042015415448331, style=ButtonStyle.PRIMARY),
